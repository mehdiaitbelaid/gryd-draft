...
(function () {
  ...
  var TREE = [{"label": "Developers", "section": "developers", "href": "home-final/draft/index.html#developers", "kids": []}, {"label": "Hub", "section": "hub", "href": "home-final/draft/index.html#hub", "kids": [{"label": "Projects", "href": "hub-directions/g/projects.html"}, {"label": "Blog", "href": "hub-directions/g/blog.html"}, {"label": "News", "href": "hub-directions/g/news.html"}]}, {"label": "Tools", "section": "tools", "href": "home-final/draft/index.html#tools", "kids": [{"label": "Site Assessment", "href": "home-final/draft/site-assessment.html"}, {"label": "Battery modelling", "href": "home-final/draft/battery-modelling.html"}, {"label": "FHS Checker", "href": "fhs/pages/2/index.html#assess"}, {"label": "Grid constrain tool (TBC)", "href": "home-final/draft/grid-constraint.html"}]}, {"label": "FHS", "section": "fhs", "href": "fhs/pages/2/index.html", "kids": []}, {"label": "FAQs", "section": "faqs", "href": "home-final/draft/index.html#faqs", "kids": []}];
  ...
  /* The transition's own sheet, on the same terms. Nothing the transition needs
     to be correct is in it: the overlay writes its geometry and its colour as
     inline style, so a sheet that arrives late cannot leave half a cover on the
     screen. This carries the reduced motion rule and the mark's size. */
  if (!document.querySelector('link[data-page-transition]')) {
    var tlink = document.createElement('link');
    tlink.rel = 'stylesheet';
    tlink.href = new URL('page-transition.css', me.src).href;
    tlink.setAttribute('data-page-transition', '');
...
/* The mark sweep, inlined rather than linked.

   Every page that carries the shared pill carries the shared transition, and it
   has to run synchronously: an arrival opens its cover on the first line of
   script it gets, before the document under it has been parsed, and a script
   appended to the head would run a frame or more too late and show one
   uncovered frame. This script tag is already synchronous, so the transition
   rides in it. assets/page-transition.js is the same source, for the homepage,
   which prints its pill inline and loads no site-nav.js. */
